...
//  static final PermissionGroup requiredPermission = PermissionGroup.storage;
  ...
  Future<void> _getPermissionStatus() async {
    var updatedStatus = await _getStatus();
    final updatedCanPrompt = updatedStatus == PermissionStatus.granted;
    setState(() {
  ...
  Future<void> _requestPermission() async {
    if (true) {
      ...
      if (status == PermissionStatus.restricted) {
        ...
        final updated = await PermissionHandler().requestPermissions([PermissionGroup.storage]);
        status = updated[PermissionGroup.storage];
      }
